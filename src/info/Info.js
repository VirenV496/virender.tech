...
export let colors = ["rgb(0, 255, 0)", "rgb(166,104,255)"];
/*
...
export const info = {
    ...
    miniBio: [ // these are just some "tidbits" about yourself. You can look at mine https://paytonjewell.github.io/#/ for an example if you'd like
        ...
        {
            emoji: "💼",
            text: "Software Engineer at Aloha Technology"
        },
        {
            emoji: "📧",
            text: "virenderv329@gmail.com"
        }
    ],
    socials: [
        // {
        ...
        // },
        {
            link: "https://github.com/VirenV496",
            icon: "fa fa-github",
            label: 'github'
        },
        {
            link: "https://www.linkedin.com/in/virender-vishwakarma-952381176/",
            icon: "fa fa-linkedin",
            label: 'linkedin'
        },
        {
    ...
    skills:
        {
            ...
            exposedTo: ['express - nodejs', 'python', 'MongoDB', 'mysql', 'adobe illustrator']
        }
    ,
    hobbies: [
        {
            label: 'managa reading',
            emoji: '📖'
        },
        {
            label: 'theater',
